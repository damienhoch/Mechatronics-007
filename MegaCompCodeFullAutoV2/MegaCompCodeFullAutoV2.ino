...
const int mine2 = 140;
int loadDelay = 500;
const int dispense1 = 180;
const int dispense2 = 90;
...
//char currentBlocks[] = { 'W', 'W', 'W', 'W', 'W', 'W', 'R' };  // Blocks on the robot.
//char currentBlocks[] = { 'Y', 'Y', 'Y', 'W', 'W', 'W', 'R' };  // Blocks on the robot.
...
int MineApproachStop = 3;   // Stop distance from the wall (cm)
...
double KpT = 8;   // Proportional gain for TURNING trajectory following
